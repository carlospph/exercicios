...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <form action="/Site/SistemaLogin/Controllers/processarCadastro.php" method="POST">

                <div class="mt-2 mb-2">
                    <input type="text" name="userNome" id="inputNome" class="form-control form-control-lg" placeholder="Nome completo">
                </div>
                ...
                <div class="mt-2 mb-2">
                    <input type="password" name="userSenha" id="inputEmail" class="form-control form-control-lg" placeholder="Senha">
                </div>
